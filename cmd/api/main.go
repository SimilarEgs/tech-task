...
/*
Что бы изменил:
- то как мы сохраняем/удаляем/читаем юзеров (всякий раз мы считываем весь файл, что при больших объемах записей приведет к значительным растратам ресурсов)
